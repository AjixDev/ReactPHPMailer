...
if ($_SERVER['HTTP_REFERER'] === "http://localhost:3000/" || "http://localhost:80/") {
    ...
    try {
        ...
        $mail->Password = 'mailer@123'; // SMTP password
        ...
        //Recipients
        $mail->setFrom('sender@example.com', 'React Form');
        $mail->addAddress('reciever@example.com'); // Recipient Address('mail', 'name') Name is optional
